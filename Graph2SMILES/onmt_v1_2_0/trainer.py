...
def build_trainer(opt, device_id, model, fields, optim, model_saver=None):
    ...
    train_loss = Graph2SMILES.onmt_v1_2_0.utils.loss.build_loss_compute(model, tgt_field, opt)
    valid_loss = Graph2SMILES.onmt_v1_2_0.utils.loss.build_loss_compute(
    ...
    earlystopper = Graph2SMILES.onmt_v1_2_0.utils.EarlyStopping(
        opt.early_stopping, scorers=Graph2SMILES.onmt_v1_2_0.utils.scorers_from_opts(opt)) \
    ...
    if len(opt.src_noise) > 0:
        ...
        if corpus_id_field is not None:
            ...
            ids_to_noise = None
        source_noise = Graph2SMILES.onmt_v1_2_0.modules.source_noise.MultiNoise(
            opt.src_noise,
            opt.src_noise_prob,
    ...
    report_manager = Graph2SMILES.onmt_v1_2_0.utils.build_report_manager(opt, gpu_rank)
    trainer = Graph2SMILES.onmt_v1_2_0.Trainer(model, train_loss, valid_loss, optim, trunc_size,
...
class Trainer(object):
    ...
    def train(self,
        ...
        total_stats = Graph2SMILES.onmt_v1_2_0.utils.Statistics()
        ...
        for i, (batches, normalization) in enumerate(
            ...
            if self.n_gpu > 1:
                normalization = sum(Graph2SMILES.onmt_v1_2_0.utils.distributed
                                    .all_gather_list
                                    (normalization))
    ...
    def validate(self, valid_iter, moving_average=None):
        ...
        with torch.no_grad():
            stats = Graph2SMILES.onmt_v1_2_0.utils.Statistics()
            ...
            for j in range(0, target_size - 1, trunc_size):
                ...
                if self.accum_count == 1:
                    ...
                    if self.n_gpu > 1:
                        ...
                        Graph2SMILES.onmt_v1_2_0.utils.distributed.all_reduce_and_rescale_tensors(
                            grads, float(1))
                    self.optim.step()
    ...
    def _maybe_gather_stats(self, stat):
        ...
        if stat is not None and self.n_gpu > 1:
            return Graph2SMILES.onmt_v1_2_0.utils.Statistics.all_gather_stats(stat)
        return stat
