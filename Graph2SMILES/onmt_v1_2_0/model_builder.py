...
from Graph2SMILES.onmt_v1_2_0.encoders import str2enc

from Graph2SMILES.onmt_v1_2_0.decoders import str2dec

from Graph2SMILES.onmt_v1_2_0.modules import Embeddings, VecEmbedding, CopyGenerator
from Graph2SMILES.onmt_v1_2_0.modules.util_class import Cast
from Graph2SMILES.onmt_v1_2_0.utils.misc import use_gpu
...
def build_base_model(model_opt, fields, gpu, checkpoint=None, gpu_id=None):
    ...
    model = Graph2SMILES.onmt_v1_2_0.models.NMTModel(encoder, decoder)

    # Build Generator.
    if not model_opt.copy_attn:
        if model_opt.generator_function == "sparsemax":
            gen_func = Graph2SMILES.onmt_v1_2_0.modules.sparse_activations.LogSparsemax(dim=-1)
        else:
